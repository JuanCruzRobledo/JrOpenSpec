...
- **Reference implementation**: `Dashboard/src/pages/Categories.tsx`
- **Hook sources**: `Dashboard/src/hooks/useFormModal.ts`, `useConfirmDialog.ts`, `usePagination.ts`
- **Help content**: `Dashboard/src/utils/helpContent.tsx`
- **Cascade service**: `Dashboard/src/services/cascadeService.ts`
- **Form types**: `Dashboard/src/types/form.ts` (`FormState<T>`)
- **Validation**: `Dashboard/src/utils/validation.ts`
- **Logger**: `Dashboard/src/utils/logger.ts` (`handleError`, `logWarning`, `logInfo`)
- **Constants**: `Dashboard/src/utils/constants.ts` (`generateId`, `formatPrice`, `HOME_CATEGORY_NAME`)
