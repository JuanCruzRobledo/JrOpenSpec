...
### [x] Task 1.1: Initialize Vite + React 19 Project
...
### [x] Task 1.2: Vite Configuration (React Compiler + PWA)
...
### [x] Task 2.1: Menu Types
**Files**: `pwa_menu/src/types/menu.ts`

### [x] Task 2.2: Product Detail Types
**Files**: `pwa_menu/src/types/product-detail.ts`

### [x] Task 2.3: Session & Filter Types
...
### [x] Task 3.1: i18next Configuration
...
### [x] Task 3.2: Spanish Translation Files (Complete)
...
### [x] Task 3.3: English Translation Files
**Files**: `pwa_menu/src/i18n/locales/en/` (5 files)

### [x] Task 3.4: Portuguese Translation Files
...
### [x] Task 4.1: API Client with Session Token
**Files**: `pwa_menu/src/services/api-client.ts`
**Acceptance Criteria**:
- X-Table-Token header from session store
- 401/403 clears session, no JWT refresh

### [x] Task 4.2: Service Layer
...
### [x] Task 6.2: Menu Data Hook
**Files**: `pwa_menu/src/hooks/useMenuData.ts`

### [x] Task 6.3: Filter Hook (Core Filtering Logic)
...
### [x] Task 8.1: Landing Page Components
...
### [x] Task 8.2: Language Selector
**Files**: `pwa_menu/src/components/layout/LanguageSelector.tsx`

### [x] Task 8.3: Session Guard Route
...
### [x] Task 9.4: Product Grid & Section Components
...
### [x] Task 10.1: Product Detail Components
...
### [x] Task 10.2: Product Detail Modal (Container)
...
### [x] Task 11.1: Filter Drawer Components
...
### [x] Task 13.1: Router Configuration
**Files**: `pwa_menu/src/router/routes.ts`, `index.tsx`

### [x] Task 13.2: App Entry Point
...
### [x] Task 14.1: Activity Tracker Integration
**Files**: Modify `pwa_menu/src/layouts/MenuLayout.tsx`

### [x] Task 14.2: Allergen Catalog Prefetch
**Files**: Modify `pwa_menu/src/components/menu/MenuPage.tsx`

### [x] Task 14.3: PWA Icons
**Files**: `pwa_menu/public/icon-*.png`, `favicon.svg`
**Note**: PNG icon assets are present in `pwa_menu/public/`, and the manifest/runtime PWA config references those committed files directly.

### [x] Task 14.4: Backend — Session Join Endpoint
**Files**: `rest_api/app/routers/public/session_router.py`, `rest_api/app/services/domain/session_service.py`, `rest_api/app/schemas/session.py`
**Acceptance Criteria**:
