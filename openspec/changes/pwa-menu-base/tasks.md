...
**Note**: PNG placeholder files exist at 0 bytes. Manifest and vite.config.ts already reference correct paths. Real PNG assets must be generated externally (e.g., with Inkscape/ImageMagick) — cannot be produced in this environment.
