"""FlavorProfile model — system + tenant-scoped flavor descriptor."""
...
class FlavorProfile(BaseModel):
    ...
    __table_args__ = (
        UniqueConstraint("code", "tenant_id", name="uq_flavor_profiles_code_tenant"),
        CheckConstraint(
            "is_system = false OR tenant_id IS NULL",
            name="ck_flavor_profiles_system_no_tenant",
        ),
    )
